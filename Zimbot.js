// ⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈
//▮MIKAZUKI INC 2022 ®️ALL RIGHTS RESERVED
//▮
...
const reply = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "MIYAZI MIKAZUKI",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, detectLinks: true,body: "ZANSLORD", thumbnail: fs.readFileSync('./drips.jpg'),sourceUrl: ("https://youtu.be/Nfgh5MBd_b0")}}})
}
const replay = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "MIYAZI MIKAZUKI",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: "ZANSLORD", thumbnail: fs.readFileSync('./drips.jpg'),sourceUrl: ("https://youtu.be/Nfgh5MBd_b0")}}})
}
...
title: "MIYAZI MIKAZUKI",
body: "GIVE IT A STAR",
mediaType: "VIDEO",
mediaUrl: `https://github.com/ZansLord`,
description: 'ZANSLORD',
previewType: "PHOTO",
...
hydratedFooterText: `ʀᴘɢ ɢᴀᴍᴇ ʙʏ ᴢᴀɴsʟᴏʀᴅ`,
hydratedButtons:  [{        
    "urlButton": {
      "displayText": "GITHUB",
      "url": "https://github.com/ZansLord/"
    }
}, {
quickReplyButton: {
  ...
  .catch ((err) => reply(err))
          ...
          .catch ((err) => reply(err))
            ...
            const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
              ...
              "url": "https://youtube.com/c/Prodiggie"
              }
            }, {
              quickReplyButton: {
                  displayText: 'INVENTORY',
          ...
          const emote = (satu, dua) => {
            ...
            const buttonMessage = {image: {url: emoji.images[dua].url},caption: "MIYAZI MIKAZUKI",footerText: 'Loading...',buttons: buttons,headerType: 4}
...
setTimeout(function(){
  ZimBotInc.sendMessage(ZimBotInc.user.id, {text: `*MIKAZUKI INC ANNOUNCEMENT:* *FOLLOW TO ZANSLORD*\n\n*GITHUB:* https://github.com/ZansLord\n\n*NEW FEATURES COMING SOON SO STAY TUNED*\n\n*FEEL FREE TO BRING IDEAS OF THE FEATURES ON THE TABLE*\n\n*IF YOU WANT TO CONTRUBUTE FORK THE REPO, MAKE CHANGES PUSH YOUR CHANGES TO THE ORIGIN BRANCH AND WAIT FOR YOUR PULL REQUEST TO BE VERIFIED*\n\n*Thanks for choosing Miyazi-Mikazuki*`,contextInfo: { externalAdReply:{title:"MIYAZI MIKAZUKI",body:"FOLLOW ZANSLORD",showAdAttribution: true,mediaType:2,thumbnail: fs.readFileSync(`./drips.jpg`) ,mediaUrl:`https://youtu.be/Nfgh5MBd_b0`, sourceUrl: `https://youtu.be/Nfgh5MBd_b0` }}}, {quoted: m})
...
switch(command) {
  case 'quest':
    ...
    ZimBotInc.sendList(m.chat, `Hi Chomie *${pushname}*`, `Please Select Below`, "CLICK", "ʀᴘɢ ɢᴀᴍᴇ ʙʏ ᴢᴀɴsʟᴏʀᴅ ", sectionnya, { quoted: m})
    break
    case 'slime':
    case 'killslime':
...
var button = [
        ...
        ZimBotInc.sendMessage(from, { caption: hg, location: { jpegThumbnail: cing }, templateButtons: button, footer: `ʀᴘɢ ɢᴀᴍᴇ ʙʏ ᴢᴀɴsʟᴏʀᴅ`, mentions: [sender] })
...
var button = [
        ...
        var hg = `「 DEATH 」\n\n *┊ Place*  ${ad}\n ┊ *MONEY :* $${money}\n ┊ *EXP :* ${adven}Xp`
        ZimBotInc.sendMessage(from, { caption: hg, location: { jpegThumbnail: hasm }, templateButtons: button, footer: `ʀᴘɢ ɢᴀᴍᴇ ʙʏ ᴢᴀɴsʟᴏʀᴅ`, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 7000)
setTimeout( () => {
 ...
 */
  ...
  *ZIM-BOT-V4*\n\n*YOUTUBE:* https://youtu.be/Nfgh5MBd_b0\n*GITHUB:* https://github.com/ZansLord/\n\n*DONATE:* https://www.paypal.com/paypalme/zimbotinc`
  ...
  mediaType:1,
  mediaUrl: 'https://youtu.be/Nfgh5MBd_b0',
  sourceUrl: "https://youtu.be/Nfgh5MBd_b0g"
  }}
  }
  ZimBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
  }
...
if (!regex1.test(args[0])) throw 'link!'
   let [, user, repo] = args[0].match(regex1) || []
    ...
    ZimBotInc.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' , quoted: m,contextInfo: { externalAdReply:{
      ...
      thumbnail: fs.readFileSync('./drips.jpg'),
      mediaUrl:`https://youtu.be/Nfgh5MBd_b0`, 
      sourceUrl: `https://youtu.be/Nfgh5MBd_b0`,
      }}
      })
 ...
 case 'truth':
        ...
        thumbnail: fs.readFileSync(`./drips.jpg`) ,
        mediaUrl:`https://youtu.be/Nfgh5MBd_b0`, 
        sourceUrl: `https://youtu.be/Nfgh5MBd_b0` }}}, {quoted: m})
break
case 'ghsearch': 
       case 'githubsearch': 
       case 'searchgithub':
...
{ buttonId: 'stop', buttonText: { displayText: 'STOP' }, type: 1 }
  ...
  await ZimBotInc.sendButtonText(m.chat, buttons, `_You Are Still In Anonymous Session, MIKAZUKI INC To Terminate Your Anonymous Session_`, ZimBotInc.user.name, m)
  throw false
   }
...
%readmore` 
    ...
    const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://youtube.com/c/Prodiggie` } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/ZansLord/` } },
    {					
      quickReplyButton: {
      displayText: 'SPEED',
      id: 'ping'
